...
def generate_launch_description():
    # =========================================================
    # KAMERA KURULUMU: 5 WEBCAM + 1 IP KAMERA
    #
    # Kameralar dogrudan bu launch dosyasindan degil,
    # camera_manager node'u uzerinden yonetilir.
    #
    # camera_manager:
    #   - acilista 5 webcam + IP kamerayi otomatik acar
    #     (AUTO_START_CAMERAS, camera_manager.py icinde)
    #   - viewer'daki 1-2-3-4-5-6 tuslarindan gelen komutlarla
    ...
    # =========================================================
    # SCIENCE NODE
    # (Kamerayla ilgili degil, onceki kurulumda da vardi.)
    # =========================================================
    science_node = Node(
        package='cameranew_pkg',
        executable='science',

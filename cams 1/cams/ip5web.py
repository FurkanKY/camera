...
# =================================================
# KAMERA TANIMLARI
# 5 webcam + 1 IP kamera. Tuslar:
#   1 -> web1, 2 -> web2, 3 -> web3, 4 -> web4, 5 -> web5, 6 -> ip
# camera_manager.py ile ayni isimler kullanilmali.
# =================================================
CAMERAS = ["web1", "web2", "web3", "web4", "web5", "ip"]
...
class RoverCameraViewer(Node):
    def __init__(self):
        ...
        # ARAYÜZ
        # =================================================
        self.win_name = "Yildiz Rover Camera Viewer - 5 WEB + 1 IP"
        ...
        self.get_logger().info("5 -> WEB 5 ac/kapat")
        self.get_logger().info("6 -> IP CAM ac/kapat")
    ...
    def camera_status_cb(self, msg):
        """
        Beklenen format:
        web1:ON,web2:OFF,web3:ON,web4:OFF,ip:OFF
        """
